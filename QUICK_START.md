...
| 跨平台实施指南 | 技术细节和实现说明 | `docs/CROSS_PLATFORM_GUIDE.md` |
| 发布指南 | 发布流程和检查清单 | `RELEASE.md` |
| 快速开始 | 本文档 | `QUICK_START.md` |
...
| 如何发布新版本？ | `RELEASE.md` |
| 技术实现细节？ | `docs/CROSS_PLATFORM_GUIDE.md` |
| Claude 集成？ | `CLAUDE.md` |
| 项目概述？ | `README.md` |
...
6. **`RELEASE.md`** - 发布指南
7. **`docs/CROSS_PLATFORM_GUIDE.md`** - 技术指南
8. **`QUICK_START.md`** - 本文档
