...
import { g as getDefaultExportFromCjs, F as File } from "./index.js";
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = require2("worker_threads"), port = new MessageChannel().port1, ab = new ArrayBuffer();
