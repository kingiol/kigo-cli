...
> Using Anthropic's Codex models with Kigo

## Overview

Kigo supports Codex models through the Anthropic API, providing access to Codex's powerful reasoning and coding capabilities. This guide covers setup, configuration, and best practices for using Codex with Kigo.

## Supported Models

| Model | Description | Context Window | Best For |
|-------|-------------|----------------|----------|
| `Codex-opus-4-20250514` | Most capable model | 200K tokens | Complex reasoning, large codebases |
| `Codex-sonnet-4-20250514` | Balanced performance | 200K tokens | General development tasks |
| `Codex-3-5-sonnet-20241022` | Fast and efficient | 200K tokens | Quick iterations, refactoring |
| `Codex-3-5-haiku-20241022` | Fastest model | 200K tokens | Simple tasks, rapid responses |
...
export KIGO_MODEL="Codex-opus-4-20250514"
```

### 3. Run Kigo with Codex

```bash
# Use default Codex model
kigo

# Specify a specific Codex model
KIGO_MODEL="Codex-sonnet-4-20250514" kigo

# Interactive session with Codex
...
```bash
kigo --model Codex-opus-4-20250514 "your prompt"
```
...
Codex supports real-time streaming for immediate feedback:
...
Codex excels at using tools. All Kigo built-in tools work seamlessly:
...
Codex models support up to 200K tokens, enabling:
...
Codex responds well to structured prompts:
...
Codex API has rate limits. Handle gracefully:
...
KIGO_MODEL="Codex-3-5-haiku-20241022" kigo "fix typo in README"

# Use Opus only when needed
KIGO_MODEL="Codex-opus-4-20250514" kigo "design the entire system architecture"
```
...
kigo config set model.name "Codex-opus-4-20250514"
```
...
The Codex integration is implemented in `packages/core/src/models/AnthropicProvider.ts`:
...
| Feature | Codex | GPT-4 | Local Models |
|---------|--------|-------|--------------|
...
- [Codex API Reference](https://docs.anthropic.com/Codex/reference)
- [Model Pricing](https://www.anthropic.com/pricing)
- [Best Practices](https://docs.anthropic.com/Codex/docs/best-practices)
...
<p align="center">
  <sub>Powered by Codex's advanced reasoning capabilities</sub>
</p>
